    ...
    <div id="app">
        ...
        <main class="py-4">
            ...
            <div class="sidebar pe-4 pb-3">
                ...
                @endif
                <h1>{{ $receiver_info['user_name'] }}さんに相談する</h1>
                <form action="{{ url('send_order_consult_work_message', $receiver_info['id']) }}" method="POST">
                    @csrf
                        ...
                        <div class="navbar-nav">
                            @foreach ($category_info as $info)
                                @php
                                    // dd($info);
                                @endphp
                                <a href="{{ url('select_order_consult_work_category', $info->id) }}/?receiver_id={{$receiver_info['id']}}"><i class="far fa-file-alt me-2"></i>{{ $info->category_name }}</a>
                            @endforeach
                        </div>
                    ...
                    <div class="text-center mt-4">
                        <h3>相談メッセージ</h3>
                        <textarea name="work_consult" id="" cols="80" rows="10"></textarea>
                    </div>
                    <div class="text-center mt-4">
                        <button class="btn btn-primary"type="submit">この内容で相談する</button>
                    </div>
                </form>
            </div>
        </main>
