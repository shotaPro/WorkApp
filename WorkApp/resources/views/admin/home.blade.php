                ...
                <div class="sidebar pe-4 pb-3">
                    <nav class="navbar bg-light navbar-light">
                        ...
                        <div class="navbar-nav w-100">
                            <a href="{{ url('category_register_page') }}" class="nav-item nav-link active"><i
                                    class="fa fa-tachometer-alt me-2"></i>カテゴリ登録</a>
                            <a href="{{ url('post_new_page') }}" class="nav-item nav-link"><i class="fa fa-th me-2"></i>ニュース作成</a>
