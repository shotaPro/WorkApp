            ...
            <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="content mx-auto">
                    ...
                    <div class="container-fluid ml-6">
                        <form class="d-flex">
                            <input style="width: 150%" class="" type="search" placeholder="キーワードで探す">
                        ...
                        <div class="card" style="margin-top:20px;">
                            <div class="card-body">
                                ...
                                <p class="card-text">{{ ($user["user_name"]) ?  $user["user_name"] : '未設定'}}</p>
                                <h5>○スキル</h5>
                                <p class="card-text">{{ $user["skill"]  ?  $user["skill"] : '未設定'}}</p>
                                <h5>○ひとこと</h5>
                                <p class="">{{ $user["profile_text"] ? $user["profile_text"] : '未設定' }}</p>
                                <a class="btn btn-warning">気になる</a>
                                <a class="btn btn-light" href="{{ url('user_order_consult_page', $user->id) }}">この人に仕事の依頼をする</a>
